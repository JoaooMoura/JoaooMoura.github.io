  ...
  return (
    <section className="mb-32">
      ...
      >
        ...
        <p className="text-gray-400 text-lg">Trabalhos principais desenvolvidos com dedicação e qualidade</p>
      </motion.div>
          ...
          return (
            ...
            >
              <div className={`relative group ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-3xl blur-2xl group-hover:blur-3xl transition-all duration-500"></div>
